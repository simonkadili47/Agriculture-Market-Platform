        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            ...
            <input
              type="email"
              id="email"
              className="w-full px-3 py-2 text-sm text-neutral-500 border rounded-lg focus:outline-none focus:border-black"
          ...
          <div className="mb-4">
            ...
            <input
              type="password"
              id="password"
              className="w-full px-3 py-2 text-sm text-neutral-700 border rounded-lg focus:outline-none focus:border-black"
          ...
          <button
            type="submit"
            className="w-full px-4 py-2 text-sm font-bold text-white bg-indigo-600 rounded-lg"
          >
            Login
          </button>
